...
ApexHUD распространяется по **MPL-2.0**. Telemetry service использует GPL-библиотеку IRSDKSharper, поэтому публиковать объединённый проект под более слабой несовместимой лицензией было бы некорректно. См. [LICENSE](LICENSE), [Лицензирование](docs/ru/licensing.md) и [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).

Название, логотип и визуальная идентичность ApexHUD рассматриваются отдельно: [TRADEMARKS.ru.md](TRADEMARKS.ru.md).

ApexHUD — независимый community-проект, не связанный с iRacing.com Motorsport Simulations, LLC и не одобренный ею. Все марки iRacing принадлежат их правообладателям.

Copyright © 2026 Eugene Konovalov и участники ApexHUD.
